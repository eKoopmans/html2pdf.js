...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("jspdf"), require("html2canvas"), require("upng-js"));
	else if(typeof define === 'function' && define.amd)
		define("html2pdf", ["jspdf", "html2canvas", "upng-js"], factory);
	else if(typeof exports === 'object')
		exports["html2pdf"] = factory(require("jspdf"), require("html2canvas"), require("upng-js"));
	else
		root["html2pdf"] = factory(root["jspdf"], root["html2canvas"], root["upng-js"]);
})(self, function(__WEBPACK_EXTERNAL_MODULE_jspdf__, __WEBPACK_EXTERNAL_MODULE_html2canvas__, __WEBPACK_EXTERNAL_MODULE_upng_js__) {
...
/* harmony import */ var jspdf__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! jspdf */ "jspdf");
/* harmony import */ var jspdf__WEBPACK_IMPORTED_MODULE_34___default = /*#__PURE__*/__webpack_require__.n(jspdf__WEBPACK_IMPORTED_MODULE_34__);
/* harmony import */ var html2canvas__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! html2canvas */ "html2canvas");
...
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./utils.js */ "./src/utils.js");
/* harmony import */ var upng_js__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! upng-js */ "upng-js");
/* harmony import */ var upng_js__WEBPACK_IMPORTED_MODULE_37___default = /*#__PURE__*/__webpack_require__.n(upng_js__WEBPACK_IMPORTED_MODULE_37__);
/* harmony import */ var es6_promise__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! es6-promise */ "./node_modules/es6-promise/dist/es6-promise.js");
/* harmony import */ var es6_promise__WEBPACK_IMPORTED_MODULE_38___default = /*#__PURE__*/__webpack_require__.n(es6_promise__WEBPACK_IMPORTED_MODULE_38__);
...
var Promise = (es6_promise__WEBPACK_IMPORTED_MODULE_38___default().Promise);
/* ----- CONSTRUCTOR ----- */
...
Worker.prototype.from = function from(src, type) {
  function getType(src) {
    switch ((0,_utils_js__WEBPACK_IMPORTED_MODULE_36__.objType)(src)) {
      case 'string':
        return 'string';
  ...
  return this.then(function from_main() {
    ...
    switch (type) {
      case 'string':
        return this.set({
          src: (0,_utils_js__WEBPACK_IMPORTED_MODULE_36__.createElement)('div', {
            innerHTML: src
          })
        });
...
Worker.prototype.toContainer = function toContainer() {
  ...
  return this.thenList(prereqs).then(function toContainer_main() {
    ...
    var source = (0,_utils_js__WEBPACK_IMPORTED_MODULE_36__.cloneNode)(this.prop.src, this.opt.html2canvas.javascriptEnabled);
    this.prop.overlay = (0,_utils_js__WEBPACK_IMPORTED_MODULE_36__.createElement)('div', {
      className: 'html2pdf__overlay',
      style: overlayCSS
    });
    this.prop.container = (0,_utils_js__WEBPACK_IMPORTED_MODULE_36__.createElement)('div', {
...
Worker.prototype.toCanvas = function toCanvas() {
  ...
  return this.thenList(prereqs).then(function toCanvas_main() {
    ...
    return html2canvas__WEBPACK_IMPORTED_MODULE_35__(this.prop.container, options);
...
Worker.prototype.toPdf = function toPdf() {
  ...
  return this.thenList(prereqs).then(function toPdf_main() {
    ...
    this.prop.pdf = this.prop.pdf || new jspdf__WEBPACK_IMPORTED_MODULE_34__.jsPDF(opt.jsPDF);
    ...
    for (var page = 0; page < nPages; page++) {
      ...
      var imgData = opt.image.type.toLowerCase() === 'png' ? this.toPNG(pageCanvas, opt.image.quality) : pageCanvas.toDataURL('image/' + opt.image.type, opt.image.quality);
...
Worker.prototype.set = function set(opt) {
  ...
  if ((0,_utils_js__WEBPACK_IMPORTED_MODULE_36__.objType)(opt) !== 'object') {
    return this;
...
Worker.prototype.setMargin = function setMargin(margin) {
  return this.then(function setMargin_main() {
    ...
    switch ((0,_utils_js__WEBPACK_IMPORTED_MODULE_36__.objType)(margin)) {
      case 'number':
...
Worker.prototype.setPageSize = function setPageSize(pageSize) {
  return this.then(function setPageSize_main() {
    ...
    pageSize = pageSize || jspdf__WEBPACK_IMPORTED_MODULE_34__.jsPDF.getPageSize(this.opt.jsPDF); // Add 'inner' field if not present.
    ...
    if (!pageSize.hasOwnProperty('inner')) {
      ...
      pageSize.inner.px = {
        width: (0,_utils_js__WEBPACK_IMPORTED_MODULE_36__.toPx)(pageSize.inner.width, pageSize.k),
        height: (0,_utils_js__WEBPACK_IMPORTED_MODULE_36__.toPx)(pageSize.inner.height, pageSize.k)
      };
...
Worker.prototype.toPNG = function (canvas, quality) {
  var colors = quality === 0 || quality === 1 ? 0 : getColorsFromQuality(quality);
  var dt = canvas.getContext('2d').getImageData(0, 0, canvas.width, canvas.height).data;
  var png = upng_js__WEBPACK_IMPORTED_MODULE_37__.encode([dt.buffer], canvas.width, canvas.height, colors);
  return 'data:image/png;base64,' + btoa(new Uint8Array(png).reduce(function (data, byte) {
    return data + String.fromCharCode(byte);
  }, ''));

  function getColorsFromQuality(qual) {
    // we need to get int value between 2 to 8
    var pow = Math.min(8, Math.max(2, Math.floor(qual * 10)));
...
"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE_upng_js__;
